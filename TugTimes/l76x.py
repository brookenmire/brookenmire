    ...
    def L76X_Gat_GNRMC(self):
        ...
        try:
            for i in range(0, BUFFSIZE-71):
                if ((add + 5) > len(data)):
                    self.Status = -1
                    #print(f"Data on try: {data}")
                    #print(f"Mem: {gc.mem_free()}, Data: {len(data)}, Buffsize: {BUFFSIZE}, Add: {add + 5}")
                    return
                ...
                and ord(data[add+5]) == 67):   # Decimal Ascii for $GNRMC
                        x = 0
                        z = 0
                        while(x < 12):
                            if(add+z >= BUFFSIZE-1):
                            ...
                            if(ord(data[add+z]) == 44):#,
                                x = x + 1
                                if(x == 1):
                                    Time = int(ord(data[add+z+1:add+z+7]))
                                    self.Time_H = int(Time/10000)
                                    self.Time_M = int(Time/100%100)
                                    self.Time_S = int(Time%100)
                                    if(self.Time_H >= 24):
                                    ...
                                    for k in range(0, BUFFSIZE-1):
                                        ...
                                        if(ord(data[add+z+k+1]) == 46):#.
                                            break
                                        self.Speed = (ord(data[add+z+k+1]) - 48) + self.Speed*10
                                elif (x == 8): # Course
                                    self.Course = 0
                                    for k in range(0, BUFFSIZE-1):
                                        if(add+z+k >= BUFFSIZE-1):
                                        ...
                                        if(ord(data[add+z+k+1]) == 46):#.
                                            break
                                        self.Course = (ord(data[add+z+k+1]) - 48) + self.Course*10
                                elif (x == 9): # Date
                                    self.Date = 0
                                    for k in range(0, BUFFSIZE-1):
                                        if(add+z+k >= BUFFSIZE-1):
                                        ...
                                        if(ord(data[add+z+k+1]) == 44):#,
                                            break
                                        self.Date = (ord(data[add+z+k+1]) - 48) + self.Date*10
                                    self.Date_D = int(self.Date/10000)
                                    self.Date_M = int(self.Date/100%100)
                                    self.Date_Y = int((self.Date%100) + 2000)
                            ...
                            if((data[add+z]) == 44):#,
                                ...
                                if(x == 1):
                                    ...
                                    for k in range(0, BUFFSIZE-1):
                                        ...
                                        if(data[add+z+k+1] == 46):#.
                                            break
                                        self.Speed = (data[add+z+k+1] - 48) + self.Speed*10
                                elif (x == 8): # Course
                                    self.Course = 0
                                    for k in range(0, BUFFSIZE-1):
                                        if(add+z+k >= BUFFSIZE-1):
                                        ...
                                        if(data[add+z+k+1] == 46):#.
                                            break
                                        self.Course = (data[add+z+k+1] - 48) + self.Course*10
                                elif (x == 9): # Date
                                    self.Date = 0
                                    for k in range(0, BUFFSIZE-1):
                                        if(add+z+k >= BUFFSIZE-1):
                                        ...
                                        if(data[add+z+k+1] == 44):#,
                                            break
                                        self.Date = (data[add+z+k+1] - 48) + self.Date*10
                                    self.Date_D = int(self.Date/10000)
                                    self.Date_M = int(self.Date/100%100)
                                    self.Date_Y = int((self.Date%100) + 2000)
                                    return#Completion calculation
